...
console.log(db.movies.estimatedDocumentCount())
console.log(db.genres.estimatedDocumentCount())
console.log(db.users.estimatedDocumentCount())
console.log(db.rankings.estimatedDocumentCount())
